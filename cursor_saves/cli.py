...
def main():
    ...
    if not args.command:
        print(
            ...
            "  snapshots             List snapshot projects in ~/.cursaves/\n"
            "  push -s               Select workspace + conversations to push\n"
            "  pull -s               Select which projects to import\n"
            "  delete -s             Select which projects to delete\n"
            "  delete --all-projects Delete ALL snapshots\n"
            "\n"
            "─── Run from project directory (or use -w/-p) ──────────────────\n"
            "\n"
            "  push                  Save + commit + push conversations\n"
            "  pull                  Pull + import conversations\n"
            "  list                  List conversations in this project\n"
            "  status                Show what's synced vs local-only\n"
            "  delete                Delete snapshots for this project\n"
            "  delete --all          Delete all snapshots for this project\n"
            "\n"
            "─── Options ─────────────────────────────────────────────────────\n"
            "\n"
